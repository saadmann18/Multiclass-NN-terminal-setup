...
class TestDeviceOptimizations:
    ...
    @patch('os.cpu_count')
    def test_setup_cpu_optimizations(self, mock_cpu_count, mock_interop_threads, mock_threads):
    ...
    @patch('torch.set_num_threads')
    @patch('os.cpu_count')
    def test_setup_cpu_optimizations_high_core_count(self, mock_cpu_count, mock_threads):
    ...
    @patch('torch.set_num_threads')
    @patch('os.cpu_count')
    def test_setup_cpu_optimizations_exception_handling(self, mock_cpu_count, mock_threads):
