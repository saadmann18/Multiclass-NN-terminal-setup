...
def train_cli():
    ...
    parser.add_argument(
        "--compile", action="store_true", help="Enable torch.compile (PyTorch 2.0+)"
    )
    parser.add_argument("--data-dir", type=str, help="Directory to store MNIST data")
...
def eval_cli():
    ...
    parser.add_argument("--config", "-c", type=str, help="Path to configuration file")
    parser.add_argument(
        "--checkpoint", "--ckpt", type=str, help="Path to model checkpoint"
    )
    parser.add_argument(
        "--device",
        "-d",
    ...
    parser.add_argument(
        "--no-plot", action="store_true", help="Don't show confusion matrix plot"
    )
    parser.add_argument("--data-dir", type=str, help="Directory containing MNIST data")
